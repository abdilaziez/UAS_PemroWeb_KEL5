      ...
      <div class="wrap-contact100">
        <div class="contact100-form-title" style="background-image: url(images/bg-01.jpg);">
          ...
          <span class="contact100-form-title-2">
            Masukkan data perkembangan covid-19 terbaru
          </span>
        </div>

        <form class="contact100-form validate-form" action="" method="POST" >
          <div class="wrap-input100">
            <span class="label-input100">Positif</span>
            <input class="input100" type="text" name="positif" placeholder="Masukkan data jumlah kasus positif hari ini">
            <span class="focus-input100"></span>
          </div>

          <div class="wrap-input100">
            <span class="label-input100">PDP</span>
            <input class="input100" type="text" name="pdp" placeholder="Masukkan data jumlah kasus PDP hari ini">
            <span class="focus-input100"></span>
          </div>

          <div class="wrap-input100">
            <span class="label-input100">ODP</span>
            <input class="input100" type="text" name="odp" placeholder="Masukkan data jumlah kasus ODP hari ini">
            <span class="focus-input100"></span>
          </div>

          <div class="container-contact100-form-btn">
            <button class="contact100-form-btn" name="tambahData">
              <span>
                Tambah Data Terbaru
