      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
              <div class="col-md-8 mt-lg-5 text-center">
                <h1>Halaman Tambah Rumah Sakit</h1>
              </div>
        </div>
      </div>
    </div>
      ...
      <div class="wrap-contact100">
        <div class="contact100-form-title" style="background-image: url(images/bg-01.jpg);">
          ...
          <span class="contact100-form-title-2">
            Masukkan data rumah sakit
          </span>
        </div>

        <form class="contact100-form validate-form" action="" method="POST" >
          <div class="wrap-input100">
            <span class="label-input100">Nama Rumah Sakit</span>
            <input class="input100" type="text" name="namaRs" placeholder="Masukkan Nama Rumah Sakit">
            <span class="focus-input100"></span>
          </div>

          <div class="wrap-input100 " >
            <span class="label-input100">Daerah</span>
            <input class="input100" type="text" name="daerah" placeholder="Masukkan Daerah Rumah Sakit">
            <span class="focus-input100"></span>
          </div>
